...
function hm_notifications_render() {
    ...
    ?>
    <div id="hm-app" class="hearmed-notifications">
        ...
        <div class="hm-notif-day-panel">
            ...
            <div class="hm-notif-day-tiles" id="hm-day-tiles">
                <div class="hm-day-tile" data-tile="appointments">
                    <div class="hm-day-tile__val" id="tile-appointments">—</div>
                    <div class="hm-day-tile__lbl">Appointments</div>
                </div>
                <div class="hm-day-tile" data-tile="tests">
                    <div class="hm-day-tile__val" id="tile-tests">—</div>
                    <div class="hm-day-tile__lbl">Tests Scheduled</div>
                </div>
                <div class="hm-day-tile" data-tile="calls">
                    <div class="hm-day-tile__val" id="tile-calls">—</div>
                    <div class="hm-day-tile__lbl">Calls to Make</div>
                </div>
                <div class="hm-day-tile" data-tile="repairs">
                    <div class="hm-day-tile__val" id="tile-repairs">—</div>
                    <div class="hm-day-tile__lbl">Repairs Overdue</div>
                </div>
                <div class="hm-day-tile" data-tile="fittings">
                    <div class="hm-day-tile__val" id="tile-fittings">—</div>
                    <div class="hm-day-tile__lbl">Fittings Due</div>
                </div>
                <div class="hm-day-tile" data-tile="ha_not_received">
                    <div class="hm-day-tile__val" id="tile-ha-not-received">—</div>
                    <div class="hm-day-tile__lbl">HAs Not Received</div>
                </div>
            </div>
        </div>
