...
function hm_kpi_render() {
    ...
    /* Scoped box-sizing reset — NO margin/padding nuke */
    #hm-kpi *, #hm-kpi *::before, #hm-kpi *::after {
    ...
    #hm-kpi .kpi-metric__status--miss { font-family: var(--kpi-mono); }
    #hm-kpi .kpi-metric--hit { border-top: 2px solid var(--kpi-green); }

    /* ── Sparkline ── */
    #hm-kpi .kpi-spark { display: block; }

    /* ── Ring gauge ── */
    #hm-kpi .kpi-ring { position: relative; display: inline-block; }
    #hm-kpi .kpi-ring__label { position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; }
    #hm-kpi .kpi-ring__pct { font-family: var(--kpi-mono); font-weight: 700; margin: 0; }
    ...
    #hm-kpi .kpi-tag--return { background: var(--kpi-red-bg); border: 1px solid #FECACA; }
    ...
    #hm-kpi .kpi-vault__set-pin { display: flex; gap: 8px; margin: 12px 0 0; }
    ...
    #hm-kpi .kpi-delta--up { color: var(--kpi-green); }
    #hm-kpi .kpi-delta--down { color: var(--kpi-red); }
    ...
    @media (min-width: 1600px) {
        #hm-kpi .kpi-row--6 { grid-template-columns: repeat(6, 1fr); }
    }
    @media (max-width: 1599px) and (min-width: 1101px) {
        #hm-kpi .kpi-row--6 { grid-template-columns: repeat(3, 1fr); }
    }
    @media (max-width: 1100px) {
        #hm-kpi .kpi-row--6 { grid-template-columns: repeat(2, 1fr); }
        #hm-kpi .kpi-row--split { grid-template-columns: 1fr; }
        #hm-kpi .kpi-row--2 { grid-template-columns: 1fr; }
        #hm-kpi { padding: 8px 16px 32px; }
    }
    @media (max-width: 768px) {
        #hm-kpi .kpi-row--6 { grid-template-columns: 1fr; }
